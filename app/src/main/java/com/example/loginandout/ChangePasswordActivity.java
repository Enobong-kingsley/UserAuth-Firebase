...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewAuthenticated = findViewById(R.id.textView_change_pwd_authentication);
                    ...
                    firebaseUser.reauthenticate(credential).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                ...
                                // Disable editText for current password. Enable Edittext for New Pass
                                editTextPwdCurr.setEnabled(true);
                                editTextPwdNew.setEnabled(true);
                                editTextPwdConfirmNew.setEnabled(true);

                                // Enable change pwd Button. Dissable Authentication Bttn
